...
//  InAppPurchase
//
//  Created by Mac Pro 15 on 2022/11/28.
//
...
class ViewController: UIViewController {
    //1. 인앱 상품 ID 정의
    var productIdentifiers: Set<String> = ["com.taehwan.AppStoreSample"]
    ...
    //3. productIdentifiers에 정의된 상품ID에 대한 정보 가져오기 및 사용자의 디바이스가 인앱결제 가능한지 여부 확인
...
extension ViewController: SKProductsRequestDelegate {
    ...
    func productsRequest(_ request: SKProductsRequest, didReceive response: SKProductsResponse) {
            ...
            if products.count > 0 {
                ...
                print("No Product Found") //계약 업데이트X, 유료 계약X, Capablity 등록X
            }
        }
